...
**Character:** Uma única sans humanista carregando toda a interface — legível em telas pequenas, neutra o bastante para deixar o dado clínico falar. _Nota: Inter está na lista de fontes batidas do detector; a troca por uma face com mais personalidade é decisão aberta da spec 05 — até lá, Inter é o padrão documentado._
...
_Estado conhecido: o dark mode atual em `styles.css` é o default slate do shadcn, sem a identidade navy — tratado como pendência da spec 05, não como parte deste sistema._
